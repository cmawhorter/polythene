(function (global, factory) {
  ...
  (global = global || self, factory(global.polythene = {}, global['polythene-core-css'], global['polythene-theme'], global['polythene-css-shadow']));
  ...
  var _top_menu = function top_menu(selector, vars) {
    ...
    }), polytheneCoreCss.createMarker(vars, behaviorVars), {
      " .pe-menu__panel": {
        position: "fixed",
        width: "100vw",
        top: 0,
  ...
  var varFns = _objectSpread({
    general_styles: function general_styles(selector, vars) {
      ...
      }]), _defineProperty({}, polytheneCoreCss.selectorRTL(selector), alignRight())];
    },
  ...
  var addStyle = polytheneCoreCss.styler.createAddStyle(selector, fns, menuVars);
  var getStyle = polytheneCoreCss.styler.createGetStyle(selector, fns, menuVars);
