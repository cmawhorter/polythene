(function (global, factory) {
  ...
  var _mini = function mini(miniSelector, vars) {
    return (// eslint-disable-line no-unused-vars
      polytheneCoreCss.sel(miniSelector, {
        " .pe-dialog__content": {
          marginLeft: 0,
          marginRight: 0
        }
  ...
  var _permanent = function permanent(permanentSelector, vars) {
    return (// eslint-disable-line no-unused-vars
      polytheneCoreCss.sel(permanentSelector, {
        position: "static",
        display: "block",
        padding: 0,
        overflow: "initial",
  ...
  var _push = function push(pushSelector, vars) {
    return (// eslint-disable-line no-unused-vars
      polytheneCoreCss.sel(pushSelector, {
        position: "static"
      })
    );
  };
  ...
  var varFns = _objectSpread({
    ...
    general_styles: function general_styles(selector, vars) {
      return [polytheneCoreCss.sel(selector, [alignLeft(selector, vars), {
        ...
        // Cover (default)
        ".pe-drawer--cover": _cover(selector, vars),
        // Push
  ...
  var themeVars = _objectSpread({
    ...
    permanent: false,
    push: false,
    z_index: polytheneTheme.vars.z_drawer
