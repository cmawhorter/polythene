(function (global, factory) {
  ...
  (global = global || self, factory(global.polythene = {}, global['polythene-mithril-base'], global['polythene-core'], global['polythene-core-dialog'], global['polythene-mithril-dialog-pane'], global['polythene-mithril-shadow']));
  ...
  var DialogInstance = polytheneMithrilBase.ComponentCreator(_objectSpread({}, polytheneCoreDialog.coreDialog, {
    createContent: function createContent(vnode, args) {
      return polytheneCoreDialog.coreDialog.createContent(vnode, _objectSpread({}, args, {
        ...
        Pane: polytheneMithrilDialogPane.DialogPane,
  ...
  var Dialog = polytheneMithrilBase.ComponentCreator(Multiple);
