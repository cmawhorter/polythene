(function (global, factory) {
  ...
  var sizeDirective = function sizeDirective(size) {
    return function (selector, vars) {
      return polytheneCoreCss.sel(selector, _defineProperty({}, ".pe-icon--".concat(size), {
  ...
  var addStyle = polytheneCoreCss.styler.createAddStyle(selector, fns, iconVars);
  var getStyle = polytheneCoreCss.styler.createGetStyle(selector, fns, iconVars);
