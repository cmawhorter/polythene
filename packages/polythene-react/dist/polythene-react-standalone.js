(function (global, factory) {
  ...
  (global = global || self, factory(global.polythene = {}, global.React, global.ReactDOM));
    ...
    return (
      ...
      function (_React$Component) {
        ...
        function _class(props) {
          ...
          var vnode = _objectSpread$2({}, component, {
            state: {},
            attrs: _this.props,
  ...
  var renderer = function renderer() {
    ...
    return _typeof$1(args[0]) === "object" ? reactHyperscript.call.apply(reactHyperscript, [null, MithrilToReact(args[0])].concat(_toConsumableArray$1(args.slice(1)))) : reactHyperscript.call.apply(reactHyperscript, [null].concat(args));
  };

  renderer.trust = function (html) {
    var element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "div";
    if (html == null) html = "";
    return reactHyperscript(element, {
    ...
    return (
      ...
      function (_React$Component) {
        ...
        function _class(props) {
          ...
          _this.registerDOM = _this.registerDOM.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
          _this._render = _this._render.bind(_assertThisInitialized$1(_assertThisInitialized$1(_this)));
          return _this;
        }
        ...
        _createClass$1(_class, [{
          ...
          value: function _render() {
            ...
            return renderer(component || getElement(vnode), _extends$1({}, createProps(vnode, {
              renderer: renderer,
  ...
  var createProps = function createProps(vnode, _ref) {
    ...
    }, attrs.events, inactive ? null : (_ref2 = {}, _defineProperty$3(_ref2, k.tabindex, disabled || inactive ? -1 : attrs[k.tabindex] || 0), _defineProperty$3(_ref2, k.onclick, onClickHandler), _defineProperty$3(_ref2, k.onkeyup, function (e) {
  ...
  var createContent = function createContent(vnode, _ref3) {
    ...
    var label = attrs.content ? attrs.content : attrs.label !== undefined ? _typeof$2(attrs.label) === "object" ? attrs.label : h("div", {
    ...
    return h("div", (_h = {}, _defineProperty$3(_h, k.class, classes.content), _defineProperty$3(_h, "style", attrs.style), _h), [h(Shadow, {
      key: "shadow",
  ...
  var createProps$2 = function createProps(vnode, _ref) {
    var k = _ref.keys;
    var attrs = vnode.attrs;
    return _objectSpread$4({}, filterSupportedAttributes(attrs), {
  ...
  var Icon = ComponentCreator(_objectSpread$5({}, icon, {
    createProps: function createProps(vnode, args) {
      return icon.createProps(vnode, _objectSpread$5({}, args, {
        SVG: SVG
      }));
    },
    createContent: function createContent(vnode, args) {
      return icon.createContent(vnode, _objectSpread$5({}, args, {
        SVG: SVG
      }));
    }
  }));
  ...
  var TextButton = ComponentCreator(_objectSpread$6({}, button, {
    createProps: function createProps(vnode, args) {
      return button.createProps(vnode, _objectSpread$6({}, args, {
        Ripple: Ripple,
        Icon: Icon,
        Shadow: Shadow
      }));
    ...
    createContent: function createContent(vnode, args) {
      return button.createContent(vnode, _objectSpread$6({}, args, {
        Ripple: Ripple,
        Icon: Icon,
        Shadow: Shadow
      }));
  ...
  var RaisedButton = ComponentCreator(_objectSpread$6({}, raisedButton, {
    createProps: function createProps(vnode, args) {
      return raisedButton.createProps(vnode, _objectSpread$6({}, args, {
        Shadow: Shadow
      }));
    },
    createContent: function createContent(vnode, args) {
      return raisedButton.createContent(vnode, _objectSpread$6({}, args, {
        Shadow: Shadow
      }));
    },
  ...
  var primaryContent = function primaryContent(h, k, requiresKeys, attrs, children) {
    ...
    var props = _extends$8({}, filterSupportedAttributes(attrs), attrs.events, requiresKeys ? {
      ...
      style: null
    }, hasTabIndex && _defineProperty$7({}, k.tabindex, attrs[k.tabindex] || 0), url);
  ...
  var secondaryContent = function secondaryContent(h, k, requiresKeys, Icon) {
    ...
    return h(element, _extends$8({}, url, {
      ...
      key: "secondary"
    } : null, filterSupportedAttributes(attrs), hasTabIndex && _defineProperty$7({}, k.tabindex, attrs[k.tabindex] || 0)), h("div", {
      className: classes$7.content
  ...
  var createProps$8 = function createProps(vnode, _ref3) {
    ...
    }, hasTabIndex && _defineProperty$7({}, k.tabindex, attrs[k.tabindex] || 0) // events and url are attached to primary content to not interfere with controls
    );
  };
  ...
  var ListTile = ComponentCreator(_objectSpread$7({}, listTile, {
    createProps: function createProps(vnode, args) {
      return listTile.createProps(vnode, _objectSpread$7({}, args, {
        Icon: Icon,
        Ripple: Ripple
      }));
    },
    createContent: function createContent(vnode, args) {
      return listTile.createContent(vnode, _objectSpread$7({}, args, {
        Icon: Icon,
        Ripple: Ripple
      }));
    }
  ...
  var Card = ComponentCreator(_objectSpread$8({}, card, {
    createContent: function createContent(vnode, args) {
      return card.createContent(vnode, _objectSpread$8({}, args, {
  ...
  var createContent$8 = function createContent(vnode, _ref3) {
    ...
    return h("label", _extends$a({}, {
    ...
    }, state.viewControlClickHandler && _defineProperty$a({}, k.onclick, function (e) {
      return e.preventDefault(), state.viewControlClickHandler(e);
    })), [h(ViewControl, _extends$a({}, attrs, {
      inactive: inactive,
      checked: checked,
      key: "control",
      events: _defineProperty$a({}, k.onkeydown, state.viewControlKeyDownHandler)
      ...
      disabled: "disabled"
    } : _defineProperty$a({}, k.onchange, state.onChange)))]);
  };
  ...
  var IconButton = ComponentCreator(_objectSpread$9({}, iconButton, {
    createProps: function createProps(vnode, args) {
      return iconButton.createProps(vnode, _objectSpread$9({}, args, {
        Icon: Icon
      }));
    },
    createContent: function createContent(vnode, args) {
      return iconButton.createContent(vnode, _objectSpread$9({}, args, {
        Icon: Icon
      }));
    },
    component: Button
  ...
  var ViewControl = ComponentCreator(_objectSpread$a({}, viewControl, {
    createContent: function createContent(vnode, args) {
      return viewControl.createContent(vnode, _objectSpread$a({}, args, {
        Icon: Icon,
  ...
  var SelectionControl = ComponentCreator(_objectSpread$a({}, selectionControl, {
    createContent: function createContent(vnode, args) {
      return selectionControl.createContent(vnode, _objectSpread$a({}, args, {
        ViewControl: ViewControl
      }));
    }
  }));
  SelectionControl["displayName"] = "SelectionControl";
  var Checkbox = ComponentCreator(_objectSpread$a({}, checkbox, {
  ...
  var createContent$b = function createContent(vnode, _ref2) {
    ...
    }, attrs.title)) : null, h("div", _defineProperty$e({
  ...
  var DialogInstance = ComponentCreator(_objectSpread$b({}, dialog, {
    createContent: function createContent(vnode, args) {
      return dialog.createContent(vnode, _objectSpread$b({}, args, {
        Shadow: Shadow,
        Pane: DialogPane,
  ...
  var DrawerInstance = ComponentCreator(_objectSpread$c({}, drawer, {
  ...
  var Drawer = function Drawer(props) {
    return renderer(DrawerToggle, _extends$f({}, props, {
  ...
  var FAB = ComponentCreator(_objectSpread$d({}, fab, {
    createProps: function createProps(vnode, args) {
      return fab.createProps(vnode, _objectSpread$d({}, args, {
        Icon: Icon
      }));
    },
    createContent: function createContent(vnode, args) {
      return fab.createContent(vnode, _objectSpread$d({}, args, {
        Icon: Icon
      }));
    },
    component: Button
  ...
  var BaseSpinner = ComponentCreator(_objectSpread$e({}, spinner$1, {
    createContent: function createContent(vnode, args) {
      return spinner$1.createContent(vnode, _objectSpread$e({}, args, {
        Shadow: Shadow
      }));
    }
  }));
  ...
  var SpinnerInstance = ComponentCreator(_objectSpread$f({}, spinner, {
  ...
  var IOSSpinner = function IOSSpinner(props) {
    return renderer(SpinnerToggle, _objectSpread$f({}, props, {
  ...
  var createProps$i = function createProps(vnode, _ref) {
    var k = _ref.keys;
    var attrs = vnode.attrs;
    return _extends$j({}, filterSupportedAttributes(attrs), {
  ...
  var createContent$f = function createContent(vnode, _ref2) {
    ...
    if (attrs.header) {
      headerOpts = _extends$j({}, attrs.header);
    ...
    return [headerOpts ? h(ListTile, _objectSpread$g({}, requiresKeys ? {
      key: "header"
    } : undefined, attrs.all, headerOpts, {
      header: true
    })) : undefined, attrs.all ? tiles.map(function (tileOpts) {
      return h(ListTile, _objectSpread$g({}, attrs.all, tileOpts));
    }) : tiles];
  };
  ...
  var List = ComponentCreator(_objectSpread$h({}, list, {
    createProps: function createProps(vnode, args) {
      return list.createProps(vnode, _objectSpread$h({}, args, {
        ListTile: ListTile
      }));
    },
    createContent: function createContent(vnode, args) {
      return list.createContent(vnode, _objectSpread$h({}, args, {
        ListTile: ListTile
      }));
    }
  }));
  ...
  */
  ...
  var SpinnerInstance$1 = ComponentCreator(_objectSpread$i({}, spinner$2, {
    component: BaseSpinner
  }));
  ...
  var MaterialDesignProgressSpinner = function MaterialDesignProgressSpinner(props) {
    return renderer(SpinnerToggle$1, _objectSpread$i({}, props, {
  ...
  var SpinnerInstance$2 = ComponentCreator(_objectSpread$j({}, spinner$3, {
    component: BaseSpinner
  }));
  ...
  var MaterialDesignSpinner = function MaterialDesignSpinner(props) {
    return renderer(SpinnerToggle$2, _objectSpread$j({}, props, {
  ...
  var onMount$b = function onMount(vnode) {
    ...
    _extends$n(state.panelEl.style, attrs.style);
    ...
    if (!attrs.permanent) {
      ...
      state.handleEscape = function (e) {
        if (e.key === "Escape" || e.key === "Esc") {
          hideMenu(state, _extends$n({}, attrs, {
            hideDelay: 0
          }));
        }
      };
  ...
  var MenuInstance = ComponentCreator(_objectSpread$k({}, menu, {
    createContent: function createContent(vnode, args) {
      return menu.createContent(vnode, _objectSpread$k({}, args, {
        Shadow: Shadow
      }));
    }
  }));
  ...
  var Menu = function Menu(props) {
    return renderer(MenuToggle, _objectSpread$k({}, props, {
  ...
  var createProps$m = function createProps(vnode, _ref) {
    var k = _ref.keys;
    var attrs = vnode.attrs;
    return _extends$o({}, filterSupportedAttributes(attrs, {
      remove: ["style"]
    }), // style set in content, and set by show/hide transition
    _defineProperty$p({
  ...
  var ViewControl$1 = ComponentCreator(_objectSpread$l({}, viewControl, {
    createContent: function createContent(vnode, args) {
      return viewControl.createContent(vnode, _objectSpread$l({}, args, {
        Icon: Icon,
        IconButton: IconButton
      }));
    }
  ...
  var SelectionControl$1 = ComponentCreator(_objectSpread$l({}, selectionControl, {
    createContent: function createContent(vnode, args) {
      return selectionControl.createContent(vnode, _extends$q(args, {
        ViewControl: ViewControl$1
      }));
    }
  }));
  SelectionControl$1["displayName"] = "SelectionControl";
  var RadioButton = ComponentCreator(_objectSpread$l({}, radioButton, {
  ...
  var createProps$o = function createProps(vnode, _ref) {
    var k = _ref.keys;
    var attrs = vnode.attrs;
    return _extends$r({}, filterSupportedAttributes(attrs), {
  ...
  var createContent$i = function createContent(vnode, _ref2) {
    ...
    return buttons.length ? buttons.map(function (buttonOpts, index) {
      ...
      return h(RadioButton, _extends$r({}, {
  ...
  var RadioGroup = ComponentCreator(_objectSpread$m({}, radioGroup, {
    createContent: function createContent(vnode, args) {
      return radioGroup.createContent(vnode, _extends$s(args, {
  ...
  var RaisedButton$1 = ComponentCreator({
    ...
    view: function view(vnode) {
      return renderer(Button, _extends$t({}, {
        raised: true
  ...
  var createProps$p = function createProps(vnode, _ref) {
    var k = _ref.keys;
    var attrs = vnode.attrs;
    return _extends$u({}, filterSupportedAttributes(attrs), {
  ...
  var createContent$j = function createContent(vnode, _ref2) {
    ...
    }, [buttons.before, h(TextField, _extends$u({}, textfieldAttrs, {
      key: "input",
      ...
      attrs.onChange({
        ...
        setInputState: function setInputState(newState) {
          ...
          if (hasNewValue || hasNewFocus) {
            state.setInputState(_extends$v({}, newState, {
              vnode: vnode
            }));
          }
        }
  ...
  var createContent$k = function createContent(vnode, _ref4) {
    ...
    }, label) : null, h(inputType, _extends$v({}, {
      key: "input",
  ...
  var Search = ComponentCreator(_objectSpread$o({}, search, {
    createContent: function createContent(vnode, args) {
      return search.createContent(vnode, _objectSpread$o({}, args, {
        TextField: TextField
      }));
    }
  }));
  ...
  var createProps$r = function createProps(vnode, _ref3) {
    ...
    return _extends$w({}, filterSupportedAttributes(attrs), {
  ...
  var ViewControl$2 = ComponentCreator(_objectSpread$q({}, viewControl$1, {
    createContent: function createContent(vnode, args) {
      return viewControl$1.createContent(vnode, _objectSpread$q({}, args, {
        Shadow: Shadow,
        IconButton: IconButton
      }));
    }
  ...
  var Tab = ComponentCreator(_objectSpread$r({}, tab, {
    createProps: function createProps(vnode, args) {
      return tab.createProps(vnode, _objectSpread$r({}, args, {
        Icon: Icon
      }));
    },
    component: Button
  ...
  var Tabs = ComponentCreator(_objectSpread$r({}, tabs, {
    createContent: function createContent(vnode, args) {
      return tabs.createContent(vnode, _objectSpread$r({}, args, {
        Tab: Tab,
  ...
  var createProps$u = function createProps(vnode, _ref2) {
    var k = _ref2.keys;
    var attrs = vnode.attrs;
    return _extends$z({}, filterSupportedAttributes(attrs), {
  ...
  var Toolbar = ComponentCreator(_objectSpread$s({}, toolbar, {
    createContent: function createContent(vnode, args) {
      return toolbar.createContent(vnode, _objectSpread$s({}, args, {
        Shadow: Shadow
      }));
    }
  }));
  ...
  * @returns {string}
  ...
  var lightTintFns = _extends$A({}, generalFns, tintFns("light"));

  var darkTintFns = _extends$A({}, generalFns, tintFns("dark"));
  ...
  var lightTintFns$2 = _extends$D({}, generalFns$2, tintFns$2("light"));

  var darkTintFns$2 = _extends$D({}, generalFns$2, tintFns$2("dark"));
  ...
  var lightTintFns$1$1 = _extends$D({}, generalFns$1$1, tintFns$1$1("light"));

  var darkTintFns$1$1 = _extends$D({}, generalFns$1$1, tintFns$1$1("dark"));
  ...
  var lightTintFns$2$1 = _extends$D({}, generalFns$2$1, tintFns$2$1("light"));

  var darkTintFns$2$1 = _extends$D({}, generalFns$2$1, tintFns$2$1("dark"));
  ...
  var lightTintFns$3 = _extends$E({}, generalFns$3, tintFns$3("light"));

  var darkTintFns$3 = _extends$E({}, generalFns$3, tintFns$3("dark"));
  ...
  var lightTintFns$4 = _extends$F({}, generalFns$4, tintFns$4("light"));

  var darkTintFns$4 = _extends$F({}, generalFns$4, tintFns$4("dark"));
  ...
  */
  ...
  var lightTintFns$5 = _extends$G({}, generalFns$5, tintFns$5("light"));

  var darkTintFns$5 = _extends$G({}, generalFns$5, tintFns$5("dark"));
  ...
  var lightTintFns$6 = _extends$H({}, generalFns$6, tintFns$6("light"));

  var darkTintFns$6 = _extends$H({}, generalFns$6, tintFns$6("dark"));
  ...
  var alignSide$3 = function alignSide(isRTL) {
    return function (selector, vars$$1) {
      ...
      }, _border$2("".concat(selector, ".pe-drawer--border"), _extends$H({}, vars$$1, {
        border: true
      }), isRTL)];
    };
  };
  ...
  var lightTintFns$7 = _extends$I({}, generalFns$7, tintFns$7("light"));

  var darkTintFns$7 = _extends$I({}, generalFns$7, tintFns$7("dark"));
  ...
  var lightTintFns$8 = _extends$J({}, generalFns$8, tintFns$8("light"));

  var darkTintFns$8 = _extends$J({}, generalFns$8, tintFns$8("dark"));
  ...
  var lightTintFns$9 = _extends$K({}, generalFns$9, tintFns$9("light"));

  var darkTintFns$9 = _extends$K({}, generalFns$9, tintFns$9("dark"));
  ...
  var lightTintFns$a = _extends$L({}, generalFns$a, tintFns$a("light"));

  var darkTintFns$a = _extends$L({}, generalFns$a, tintFns$a("dark"));
  ...
  var lightTintFns$b = _extends$M({}, generalFns$b, tintFns$b("light"));

  var darkTintFns$b = _extends$M({}, generalFns$b, tintFns$b("dark"));
  ...
  var lightTintFns$c = _extends$N({}, generalFns$c, tintFns$c("light"), themeFns("light"));

  var darkTintFns$c = _extends$N({}, generalFns$c, tintFns$c("dark"), themeFns("dark"));
  ...
  */
  ...
  var lightTintFns$d = _extends$O({}, generalFns$d, tintFns$d("light"));

  var darkTintFns$d = _extends$O({}, generalFns$d, tintFns$d("dark"));
  ...
  var lightTintFns$e = _extends$P({}, generalFns$e, tintFns$e("light"));

  var darkTintFns$e = _extends$P({}, generalFns$e, tintFns$e("dark"));
  ...
  var lightTintFns$f = _extends$Q({}, generalFns$f, tintFns$f("light"));

  var darkTintFns$f = _extends$Q({}, generalFns$f, tintFns$f("dark"));
  ...
  var lightTintFns$g = _extends$R({}, generalFns$g, tintFns$g("light"));

  var darkTintFns$g = _extends$R({}, generalFns$g, tintFns$g("dark"));
  ...
  var lightTintFns$h = _extends$S({}, generalFns$h, tintFns$h("light"));

  var darkTintFns$h = _extends$S({}, generalFns$h, tintFns$h("dark"));
  ...
  var lightTintFns$i = _extends$T({}, generalFns$i, tintFns$i("light"));

  var darkTintFns$i = _extends$T({}, generalFns$i, tintFns$i("dark"));
  ...
  var lightTintFns$j = _extends$U({}, generalFns$j, tintFns$j("light"));

  var darkTintFns$j = _extends$U({}, generalFns$j, tintFns$j("dark"));
  ...
  var lightTintFns$k = _extends$V({}, generalFns$k, tintFns$k("light"));

  var darkTintFns$k = _extends$V({}, generalFns$k, tintFns$k("dark"));
  ...
  var lightTintFns$l = _extends$W({}, generalFns$l, tintFns$l("light"));

  var darkTintFns$l = _extends$W({}, generalFns$l, tintFns$l("dark"));
  ...
  var withCreateSizeVar = function withCreateSizeVar(vars$$1) {
    return vars$$1.thumb_size || vars$$1.track_height || vars$$1.track_length || vars$$1.label_height || vars$$1.icon_button_padding ? _extends$W({}, vars$$1, {
      createSize: true
    }) : vars$$1;
  };
  ...
  var lightTintFns$m = _extends$X({}, generalFns$m, tintFns$m("light"));

  var darkTintFns$m = _extends$X({}, generalFns$m, tintFns$m("dark"));
  ...
  var lightTintFns$1$2 = _extends$X({}, generalFns$1$2, tintFns$1$2("light"));

  var darkTintFns$1$2 = _extends$X({}, generalFns$1$2, tintFns$1$2("dark"));
  ...
  var lightTintFns$n = _extends$Y({}, generalFns$n, tintFns$n("light"));

  var darkTintFns$n = _extends$Y({}, generalFns$n, tintFns$n("dark"));
  ...
  var lightTintFns$o = _extends$Z({}, generalFns$o, tintFns$o("light"));

  var darkTintFns$o = _extends$Z({}, generalFns$o, tintFns$o("dark"));
...
//# sourceMappingURL=polythene-react-standalone.js.map
