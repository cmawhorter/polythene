(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polythene-core-css'), require('polythene-theme'), require('polythene-css-button'), require('polythene-css-icon-button')) :
  typeof define === 'function' && define.amd ? define(['exports', 'polythene-core-css', 'polythene-theme', 'polythene-css-button', 'polythene-css-icon-button'], factory) :
  (global = global || self, factory(global.polythene = {}, global['polythene-core-css'], global['polythene-theme'], global['polythene-css-button'], global['polythene-css-icon-button']));
}(this, function (exports, polytheneCoreCss, polytheneTheme, polytheneCssButton, polytheneCssIconButton) { 'use strict';
  ...
  var varFns = {
    ...
    tab_min_width_tablet: function tab_min_width_tablet(selector, vars) {
      return _defineProperty({}, "@media (min-width: " + polytheneTheme.vars.breakpoint_for_tablet_landscape_up + "px)", _defineProperty({}, ".pe-tabs:not(.pe-tabs--small):not(.pe-tabs--menu):not(.pe-tabs--autofit):not(.pe-tabs--scrollable):not(.pe-tabs--compact) ".concat(selector), {
